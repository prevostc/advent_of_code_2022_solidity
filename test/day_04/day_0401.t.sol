...
import "../../src/day_04/Day0401.sol";

contract Day0401Test is Test {
    Day0401 public day04;

    function setUp() public {
        day04 = new Day0401();
    }

    function test_Day0401_Example1() public {
        string memory input = vm.readFile("./test/day_04/example.txt");
        uint256 answer = day04.answer(input);
        assertEq(answer, 2);
    }

    function test_Day0401_MainChallenge() public {
